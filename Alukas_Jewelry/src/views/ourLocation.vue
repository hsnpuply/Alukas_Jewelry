        ...
        <div class="storeAddress  w-full mt-2 mb-10 relative">
            <swiper :modules="modules" :breakpoints="breakpoints" :space-between="30" @swiper="onSwiper"
                ...
                <swiper-slide class="releative" v-for="(item, index) in allStores" :key="index">
                    <div
                        class="ourStore  border-2 border-gray-400 md:border-transparent md:hover:border-black duration-[400ms] px-4 py-4 flex items-start justify-center gap-5 flex-col">
            ...
            <hr class="hidden md:block bg-title-gray h-[.34rem] mt-5">
        </div>
...
const allStores = ref({
    "store1": {
        ...
        "email": "NYCAlukas_Jewelry@gmail.com",
