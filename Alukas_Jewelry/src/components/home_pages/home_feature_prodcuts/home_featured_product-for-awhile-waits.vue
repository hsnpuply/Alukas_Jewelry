<template>
 ...
 <button
      ...
      <div class="featured_product_container relative overflow-hidden  h-[60vh] ">
        


      <div class="featured_products flex items-center justify-center
       bg-violet-7002  absolute w-full top-0
       
       "  
     :class="selectedButton === 'featured' ? 'appearList' : 'disappearList' + ' down'"
 ...
 <div class="product-frame  before:group-hover:opacity-100 before:duration-500 after:group-hover:opacity-100 after:duration-500 p-8  overflow-hidden group hover:bg-white">
        ...
        ">
        <div class="search bg-white rounded-full p-2 absolute right-3 top-4 translate-x-5 opacity-0 group-hover:opacity-100  group-hover:translate-x-0 duration-[400ms]">
            <Icon icon="mdi-light:magnify" class="text-3xl  " />
        </div>
        <div 
        class="wishlist
         bg-white rounded-full p-2 absolute right-3 top-[4.5rem] translate-x-5 opacity-0 group-hover:opacity-100  group-hover:translate-x-0 duration-[400ms]" 
         @click="toggleMyHeart()" 
         > 
        <Icon :icon="toggleHeart" class="text-3xl" />
        </div>
       ...
       <!-- <p class="bg-orange-400 p-4 rounded-full cursor-default" @click="myAlert()">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Rem ab debitis eaque.</p> -->
    </swiper-slide>
  ...
  > 
     ...
     <swiper-slide class="releative group">
      ...
      >
        ...
        <div class="wishlist bg-gray-400 !bg-white rounded-full p-2 absolute right-3 top-[4.5rem] translate-x-5 opacity-0 group-hover:opacity-100  group-hover:translate-x-0 duration-[400ms]" @click="myAlert()" > 
        <Icon :icon="toggleHeart" class="text-3xl" />
        </div>
...
const asghar=ref('myAsghar ref')

const asgharToHasan = () => {
  // asghar.value = 'Hasan to asghar'
  // alert(asghar.value)
  alert('alert!!')
}
